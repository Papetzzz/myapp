...
<head>
  ...
  <title>Login-CpE Communication System</title>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">CpE Communication System</span>
                </a>
              </div><!-- End Logo -->
                  ...
                  <form class="row g-3 needs-validation" action="Login.php" method="post" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text" name="IDNumber" class="form-control" id="YourIDNumber" required value="<?= htmlspecialchars($_POST["IDNumber"] ?? "") ?>" autocomplete="off">
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Don't have account? <a href="Registration.html">Create an account</a></p>
                    </div>
                  </form>
